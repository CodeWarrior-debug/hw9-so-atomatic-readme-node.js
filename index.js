...
const questions = [
    'Description: Please describe this project?','Outline: Provide a Table of Contents?', 'Installation: What are the required steps to install?', 'Usage: What is it supposed to be used for?', 'License: What license will you select?', 'Contributing: How can others contribute?', 'Tests: RESEARCH WHAT THE HECK THIS IS', 'QUESTIONS: RESEARCH ALSO', 'Pick your license below:'
];

// TODO: Create an array of questions for user input
const names = ['description', 'toc','installation', 'usage', 'license', 'contributing', 'tests', 'questions','license'];
...
function init() {
    ...
    .prompt(
        [
            ...
            {type: 'rawlist', message: questions[8], name: names[8],choices:['MIT','Apache']},
        ])
    .then((answers) => {
